...
class Transport_calc_field_from_widget extends Widget_Base {

	

	public static $slug = 'elementor-transport_calc_field_widget';

	public function get_name() { return self::$slug; }

	public function get_title() { return __('Start Transport', self::$slug); }
	...
	echo '<div class="calculate-from-position__from">
		<input type="text" placeholder="Откуда" id="mapFrom">
	</div>
	';
