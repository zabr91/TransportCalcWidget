...
class Transport_calc_map_widget extends Widget_Base {

	

	public static $slug = 'elementor-transport_calc_map_widget';

	public function get_name() { return self::$slug; }

	public function get_title() { return __('Elementor Transport Map', self::$slug); }

	public function get_icon() { return 'fas fa-map'; }
