...
class Transport_calc_field_mass_widget extends Widget_Base {

	

	public static $slug = 'elementor-transport_calc_mass_widget';

	public function get_name() { return self::$slug; }

	public function get_title() { return __('Mass', self::$slug); }
